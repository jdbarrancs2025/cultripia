      ...
      <Card className="max-w-md w-full">
        ...
        <CardContent className="text-center space-y-6">
          <p className="text-gray-600">
            Tu reserva no se ha completado. No se ha realizado ningún cargo a tu
            tarjeta.
          </p>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-amber-50 rounded-lg">
              <p className="text-sm text-amber-800">
                Si experimentaste algún problema durante el proceso de pago, por
                favor intenta nuevamente o contacta a nuestro equipo de soporte.
              </p>
            </div>
