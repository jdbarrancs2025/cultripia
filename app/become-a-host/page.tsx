...
export default function BecomeAHostPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.email || !formData.phone || !formData.location ||
        formData.languagesSpoken.length === 0 || !formData.experienceType ||
        !formData.experienceTitle || !formData.experienceDescription ||
        !formData.maxGuests || !formData.pricePerPerson || !formData.availability) {
      toast({
    ...
    try {
      ...
      const sanitizedData = {
        ...
        experienceTitle: sanitizeInput(formData.experienceTitle).substring(0, 100),
        experienceDescription: sanitizeInput(formData.experienceDescription).substring(0, 1000),
        maxGuests: maxGuestsNum,
        pricePerPerson: priceNum,
        availability: formData.availability,
        specialRequirements: formData.specialRequirements ? sanitizeInput(formData.specialRequirements).substring(0, 500) : undefined,
      };
    ...
    <div className="container max-w-4xl mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Share your unique cultural experiences with travelers from around the world
        </p>
      </div>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="chichicastenango">Chichicastenango</SelectItem>
                    <SelectItem value="tikal">Tikal</SelectItem>
                    <SelectItem value="semuc-champey">Semuc Champey</SelectItem>
                    <SelectItem value="guatemala-city">Guatemala City</SelectItem>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {languages.map((language) => (
                  <div key={language.value} className="flex items-center space-x-2">
                    <Checkbox
                      id={language.value}
                      checked={formData.languagesSpoken.includes(language.value)}
