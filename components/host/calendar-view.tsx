...
export function CalendarView() {
  ...
  const [selectedExperience, setSelectedExperience] =
    useState<Id<"experiences"> | null>(null);
  ...
  const bookedDates =
    bookings?.map((booking: any) => booking.selectedDate) || [];
        ...
        <CardContent>
          <div className="space-y-6">
            ...
            {selectedExperience && (
              <>
                ...
                <div className="text-sm text-gray-600">
                  ...
                  <p>
                    • Las fechas con reservas confirmadas no se pueden bloquear
                  </p>
                </div>
              </>
            )}
            ...
            {experiences && experiences.length === 0 && (
              <div className="text-center py-8 text-gray-500">
                No tienes experiencias creadas. Crea una experiencia primero
                para gestionar su disponibilidad.
              </div>
            )}
          </div>
        </CardContent>
